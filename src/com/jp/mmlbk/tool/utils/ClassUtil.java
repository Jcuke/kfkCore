package com.jp.mmlbk.tool.utils;
...
public class ClassUtil
{
     ...
     * @param classFilters
     */
    public ClassUtil(Boolean excludeInner, Boolean checkInOrEx, List<String> classFilters)
    {
...
//                    logger.info("exclude inner class with name:" + filename);
    ...
    private boolean filterClassName(String className)
    {
        ...
        {
            if(tmpName.toUpperCase().indexOf(str.toUpperCase()) != -1)
            {
                flag = true;
                break;
            }
    ...
    public static void main(String[] args)
    {
        ...
        Set<Class<?>> calssList = handler.getPackageAllClasses("com.jiaparts.css", true);
        ...
        calssList = handler.getPackageAllClasses("com.jiaparts.css", true);
        for (Class<?> cla : calssList)
        {
            System.out.println(cla.getName());
        }
